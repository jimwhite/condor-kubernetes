...
# Copied from <http://vdt.cs.wisc.edu/extras/condor.boot.2.generic>
# http://vdt.cs.wisc.edu/extras/condor.boot.2.generic.html
# This one might be better because it is for "RPM" and doesn't 
# use a PID file and in a Docker container we're not worried about
# multiple Condor setups running.
# https://htcondor-wiki.cs.wisc.edu/index.cgi/fileview?f=src/condor_examples/condor.boot.rpm&v=0c03bd66c3ebf1e9da2de3643c4639e36e733dc2
# The condor_examples files are here:
# https://htcondor-wiki.cs.wisc.edu/index.cgi/dirview?d=src/condor_examples
